   ...
   */
    ...
    */
    'grid' => [
        ...
        'grid_action_class' => Appsolutely\AIO\Grid\Displayers\DropdownActions::class,

        // The global Grid batch action display class.
        'batch_action_class' => Appsolutely\AIO\Grid\Tools\BatchActions::class,

        // The global Grid pagination display class.
        'paginator_class' => Appsolutely\AIO\Grid\Tools\Paginator::class,

        'actions' => [
            'view' => Appsolutely\AIO\Grid\Actions\Show::class,
            'edit' => Appsolutely\AIO\Grid\Actions\Edit::class,
            'quick_edit' => Appsolutely\AIO\Grid\Actions\QuickEdit::class,
            'delete' => Appsolutely\AIO\Grid\Actions\Delete::class,
            'batch_delete' => Appsolutely\AIO\Grid\Tools\BatchDelete::class,
        ],

        // The global Grid column selector setting.
        'column_selector' => [
            'store' => Appsolutely\AIO\Grid\ColumnSelector\SessionStore::class,
            'store_params' => [
                'driver' => 'file',
            ],
        ],
    ...
    */
    'database' => [
        ...
        'users_model' => Appsolutely\AIO\Models\Administrator::class,

        // Role table and model.
        'roles_table' => 'admin_roles',
        'roles_model' => Appsolutely\AIO\Models\Role::class,

        // Permission table and model.
        'permissions_table' => 'admin_permissions',
        'permissions_model' => Appsolutely\AIO\Models\Permission::class,

        // Menu table and model.
        'menu_table' => 'admin_menu',
        'menu_model' => Appsolutely\AIO\Models\Menu::class,
    ...
    */
    ...
    |
    */
    'exception_handler' => Appsolutely\AIO\Exception\Handler::class,
