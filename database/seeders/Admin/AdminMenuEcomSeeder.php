 ...
 *
 * Orders and Products grouped (multiple sub-items each), CMS items
 * flattened at top level. Ordered by daily usage: orders first,
 * then products, then content management.
 */
