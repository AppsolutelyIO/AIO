...
/**
 * Drop-in replacement for qirolab/laravel-themer's ThemeViewFinder.
 *
 * Fixes PHP 8.4 implicit nullable parameter deprecations by using
 * explicit ?string type hints. Loaded via classmap autoloading so
