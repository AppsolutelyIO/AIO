...
final class SecurityHeaders
{
    ...
    private function getContentSecurityPolicy(Request $request): ?string
    {
        ...
        if (app()->isProduction()) {
            ...
            return "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https:; style-src 'self' 'unsafe-inline' https:; img-src 'self' data: https:; font-src 'self' data: https:; media-src 'self' https:; connect-src 'self' https:; frame-src 'self' https://challenges.cloudflare.com https://insight.adsrvr.org; frame-ancestors 'self';";
        }

        // More permissive for development
        return "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https:; style-src 'self' 'unsafe-inline' https:; img-src 'self' data: https: http:; font-src 'self' data: https: http:; media-src 'self' https: http:; connect-src 'self' https: http: ws: wss:; frame-src 'self' https://challenges.cloudflare.com https://insight.adsrvr.org; frame-ancestors 'self';";
    }
