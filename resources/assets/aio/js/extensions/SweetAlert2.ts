...
export default class SweetAlert2 {
    ...
    constructor(AIO: AIOInstance) {
        ...
        w.swal = w.Swal = _this.swal = AIO.swal = Swal as unknown as Record<string, unknown>;
    ...
    fire(title: string, message?: string, type?: string, options?: Record<string, unknown>): Promise<Record<string, unknown>> {
        options = $.extend({
            title: title,
            type: type,
            html: message,
