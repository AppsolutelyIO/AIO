...
class Form {
    ...
    init() {
        ...
        AIO.confirm(confirm.title, confirm.content, function () {
            _this.submit();
        });
    }
    ...
    isValueChanged($field, column) {
        return ! AIO.helpers.equal(this.originalValues[column], this.getFieldValue($field));
    }
