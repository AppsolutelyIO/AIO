...
`).appendTo($li);
        ...
        return function () {
            ...
            switch (index) {
                ...
                case 'delete':
                    ...
                    break;
                case 'preview':
                    AIO.helpers.previewImage($(this).parent().parent().find('img').attr('src'), null, file.name);
    ...
    validateDimensions(file) {
        let _this = this,
            ...
            height = file._info.height,
            isset = AIO.helpers.isset;

        // The image dimensions is invalid.
        if (! parent.isImage() || ! _this.isImage(file) || ! AIO.helpers.len(options.dimensions)) {
            return true;
        }
