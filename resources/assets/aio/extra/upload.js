...
(function (w, $) {
    ...
    class Uploader {
        constructor(options) {
            ...
            _this.updateColumn = options.upload.formData.upload_column || ('webup' + AIO.helpers.random());
            ...
            // 翻译
            _this.lang = AIO.Translator(options.lang);
            ...
            if (typeof options.upload.formData._id === "undefined" || ! options.upload.formData._id) {
                options.upload.formData._id = _this.updateColumn + AIO.helpers.random();
            }
        }
        ...
        build() {
            ...
            uploader.onFileDequeued = function (file) {
                ...
                if (! _this.fileCount && !AIO.helpers.len(_this.formFiles)) {
            ...
            uploader.onError = function (code) {
                switch (code) {
                    ...
                    case 'Q_EXCEED_NUM_LIMIT':
                        AIO.error(_this.lang.trans('Q_EXCEED_NUM_LIMIT', {num: options.upload.fileNumLimit}));
                        break;
                    case 'F_EXCEED_SIZE':
