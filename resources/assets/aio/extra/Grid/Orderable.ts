...
export default class Orderable {
    ...
    constructor(Helper: Helper, opts: Partial<OrderableOptions>) {
        this.options = $.extend({
            button: null,
            url: '',
        }, opts) as OrderableOptions;
    ...
    request(): void {
        ...
        ($ as any).put({
            ...
            success: function(data: any){
                ...
                if (! data.status) {
                    return data.data.message && AIO.warning(data.data.message);
                }

                AIO.success(data.data.message);
